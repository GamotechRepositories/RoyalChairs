...
export default function WhyChooseUsManager() {
  const [activeSubTab, setActiveSubTab] = useState('pillars'); // 'pillars', 'craftsmanship', 'reviews'
  ...
  const handleSavePillars = () => {
    localStorage.setItem('royal_admin_why_pillars', JSON.stringify(pillars));
    dispatchStorageUpdate();
    triggerToast('4 Value Pillars saved and synced to store!');
  };
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-xs sm:text-sm mt-1">
            Manage the 4 Key Value Pillars, Craftsmanship Story Banner, and Verified Customer Reviews.
          </p>
        </div>
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-xs space-y-6">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  These 4 feature cards appear on the homepage under "Why Choose RoyalChairs".
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {pillars.map((pillar, idx) => (
                <div
                  key={pillar.id || idx}
                  className="bg-slate-50 p-5 rounded-2xl border border-slate-200/80 space-y-4 hover:border-emerald-500/40 transition"
                >
                  <div className="flex items-center justify-between">
                    ...
                    <select
                      ...
                      className="bg-white border border-slate-200 rounded-lg px-2.5 py-1 text-xs font-bold text-slate-700 cursor-pointer focus:outline-hidden"
                    >
                      {iconOptions.map((opt) => (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2 bg-white border border-slate-200 rounded-xl text-xs font-extrabold text-slate-900 focus:outline-hidden focus:border-emerald-700"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3.5 py-2 bg-white border border-slate-200 rounded-xl text-xs font-semibold text-slate-800 focus:outline-hidden focus:border-emerald-700"
                    />
                  </div>
                </div>
              ))}
