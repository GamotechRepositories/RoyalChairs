      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-slate-100 pb-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              onClick={onClose}
              className="p-2 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-600 transition border border-slate-200"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
          ...
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
            <div className="flex items-center space-x-2 text-amber-700 font-bold uppercase tracking-wider text-[10px]">
              <Crown className="w-3.5 h-3.5" />
              <span>VIP Client Information</span>
            </div>
            ...
            {order.items.map((item, i) => (
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2 mt-0.5">
                      <span className="w-3 h-3 rounded-full border border-slate-300" style={{ backgroundColor: item.color }} />
                ...
                <div className="text-right font-mono">
                  <p className="text-xs font-bold text-slate-600">₹{item.price} each</p>
        ...
        <div className="p-4 rounded-2xl bg-slate-100 border border-slate-200 space-y-2 text-xs">
          ...
          <div className="pt-2 border-t border-slate-200 flex justify-between text-sm font-black text-slate-900">
            ...
            <span className="text-emerald-800 font-mono">₹{order.total.toLocaleString()}</span>
          </div>
        </div>
